    ...
    <div class="subheader flex-wrap">
        <div class="subheader-left pt-2 pb-2">
            <div class="subheader-breadcrumbs">
                ...
                <a href="{{route('bikes.create')}}" class="breadcrumbs-link">{{__('dashboard_forms.create_now_bike')}}</a>
            </div>
        </div>

        <div class="d-flex ml-auto">
            <a href="{{route('bikes.create')}}" class="btn btn-secondary ml-2">{{__('dashboard_forms.cancel')}}</a>
    ...
    <div class="container-fluid">
        <div class="card mb-1">
            <div class="card-header">
                ...
                <div class="card-body">
                    <form action="{{ route('bikes.store') }}" method="post" id="object-form"
